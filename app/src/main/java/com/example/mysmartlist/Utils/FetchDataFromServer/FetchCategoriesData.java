...
public class FetchCategoriesData extends AsyncTask<Void,Void,String> {

    public static final  String localHostIp= Constants.localHostIp;
    public static final  String BasicUrl = localHostIp+"/smart_list/public/";
    private String url=BasicUrl+"categories";
    ...
    public String Fetching_Data(String UrlKey) {
        ...
        try {
            ...
            URL url = new URL(UrlWithKey.toString());
