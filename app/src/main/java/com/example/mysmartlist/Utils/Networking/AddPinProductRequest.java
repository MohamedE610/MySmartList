...
public class AddPinProductRequest extends FetchData implements Callback<JSONObject>  {


    private int client_id;
    private int product_id;

    public AddPinProductRequest(int client_id, int product_id){
    ...
    public void start() {
        ...
        Call<JSONObject> addPinProductCall = apiInterface.AddPinProduct(client_id,product_id);
        addPinProductCall.enqueue(this);
    }
