...
public class UpdateClientAccountRequest extends FetchData implements Callback<HashMap>  {

    int clientID;
    HashMap clientDetails;

    public UpdateClientAccountRequest(int clientID,HashMap clientDetails){
    ...
    public void start() {
        ...
        Call<HashMap>  clientAccountCall = apiInterface.updateClientAccount(clientID,clientDetails);
