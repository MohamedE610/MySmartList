...
public class FetchProductSearchData extends AsyncTask<Void,Void,String> {
    ...
    public FetchProductSearchData(  String searchValue, String filterValue) {
        this.searchValue=searchValue;
        this.filterValue=filterValue;
        try {
            url = BasicUrl + "products?q=" + URLEncoder.encode(searchValue, "UTF-8") + "&order=" +URLEncoder.encode(filterValue, "UTF-8");
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            if(JsonData==null||JsonData.equals("")) {JsonData = Fetching_Data(url);
