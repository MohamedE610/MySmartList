...
public class AddFavouriteProductRequest extends FetchData implements Callback<JSONObject>  {


    private int client_id;
    private int product_id;

    public AddFavouriteProductRequest(int client_id, int product_id){
    ...
    public void start() {
        ...
        Call<JSONObject> addFavouriteProductCall = apiInterface.AddFavouriteProduct(client_id,product_id);
        addFavouriteProductCall.enqueue(this);
    }
