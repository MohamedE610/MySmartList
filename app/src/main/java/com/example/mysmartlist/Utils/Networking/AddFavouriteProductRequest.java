...
public class AddFavouriteProductRequest extends FetchData implements Callback<HashMap>  {
    ...
    public void start() {
        ...
        Call<HashMap> addFavouriteProductCall = apiInterface.AddFavouriteProduct(client_id,product_id);
