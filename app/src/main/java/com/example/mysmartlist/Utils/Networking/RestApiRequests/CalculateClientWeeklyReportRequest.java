...
public class CalculateClientWeeklyReportRequest extends FetchData implements Callback<Reports>  {


    private int client_id;

    public CalculateClientWeeklyReportRequest(int client_id){
    ...
    public void start() {
        ...
        Call<Reports>  reportsCall = apiInterface.calculateClientWeeklyReports(client_id);
