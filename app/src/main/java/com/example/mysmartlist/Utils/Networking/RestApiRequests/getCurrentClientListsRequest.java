...
public class getCurrentClientListsRequest extends FetchData implements Callback<ClientLists>  {


    private int client_id;

    public getCurrentClientListsRequest(int client_id){
    ...
    public void start() {
        ...
        Call<ClientLists> clientListsCall = apiInterface.getCurrentClientLists(client_id);
