...
public class getWeeklyClientReportsRequest extends FetchData implements Callback<Reports>  {


    private int client_id;

    public getWeeklyClientReportsRequest(int client_id){
    ...
    public void start() {
        ...
        Call<Reports>  weeklyClientReports = apiInterface.getWeeklyClientReports(client_id);
        weeklyClientReports.enqueue(this);
    }
