...
public class getWeeklyClientReportsRequest extends FetchData implements Callback<HashMap>  {
    ...
    public void start() {
        ...
        Call<HashMap>  weeklyClientReports = apiInterface.getWeeklyClientReports(client_id);
