...
public class AddProductNotesRequest extends FetchData implements Callback<HashMap>  {


    private int client_id,product_id;
    HashMap hashMap;

    public AddProductNotesRequest(int client_id, int product_id, HashMap hashMap){
    ...
    public void start() {
        ...
        Call<HashMap>  clientCall = apiInterface.addProductNotes(client_id,product_id,hashMap);
