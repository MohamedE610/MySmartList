...
public class CalculateClientMonthlyReportRequest extends FetchData implements Callback<Reports>  {


    private int client_id;

    public CalculateClientMonthlyReportRequest(int client_id){
    ...
    public void start() {
        ...
        Call<Reports>  reportsCall = apiInterface.calculateClientMonthlyReports(client_id);
        reportsCall.enqueue(this);
    }
