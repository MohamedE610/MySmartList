...
public class deleteSingleProductRequest extends FetchData implements Callback<JSONObject>  {
    ...
    public void start() {
        ...
        Call<JSONObject>   deleteSingleProductCall = apiInterface.deleteSingleProduct(list_id,product_id+"");
