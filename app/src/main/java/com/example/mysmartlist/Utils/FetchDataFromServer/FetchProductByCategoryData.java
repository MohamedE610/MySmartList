...
public class FetchProductByCategoryData extends AsyncTask<Void,Void,String> {
    ...
    public FetchProductByCategoryData(String categoryStr) {

        this.categoryStr=categoryStr;
        url=BasicUrl+"products?category="+categoryStr;
    }
