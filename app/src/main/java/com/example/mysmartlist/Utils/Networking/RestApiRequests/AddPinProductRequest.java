...
public class AddPinProductRequest extends FetchData implements Callback<HashMap>  {
    ...
    public void start() {
        ...
        Call<HashMap> addPinProductCall = apiInterface.AddPinProduct(client_id,product_id);
