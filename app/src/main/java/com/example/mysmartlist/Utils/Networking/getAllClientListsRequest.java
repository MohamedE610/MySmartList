...
public class getAllClientListsRequest extends FetchData implements Callback<ClientLists>  {


    private int client_id;

    public getAllClientListsRequest(int client_id){
    ...
    public void start() {
        ...
        Call<ClientLists> clientListsCall = apiInterface.getAllClientLists(client_id);
